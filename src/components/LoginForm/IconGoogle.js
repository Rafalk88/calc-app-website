...
const IconGoogle = (props) => (
  <svg
    ...
    {...props}
  >
    <path fill="url(#a=IconGoogle)" d="M0 0h24v24H0z" />
    <defs>
      <pattern
        id="a=IconGoogle"
